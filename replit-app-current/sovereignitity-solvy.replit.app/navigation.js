...
// Mobile menu toggle — must live here (not in the HTML string) because
// scripts injected via innerHTML are never executed by the browser.
...
// Function to inject navigation into page using safe DOM methods.
// navigationHTML is 100% static developer-authored markup with no user data,
// but innerHTML is still an anti-pattern; DOMParser keeps intent explicit.
