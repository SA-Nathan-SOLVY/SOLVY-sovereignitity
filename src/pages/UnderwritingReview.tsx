      ...
      <div style={s.container}>
        ...
        <section style={s.section}>
          ...
          <div style={s.coopGrid}>
            {[
              { pct: '70%', label: 'Member Pool', desc: 'Held for members in the membership pool — distribution decided later, at maturity, with DECIDEY financial education. Your spending builds your equity.', color: '#7c3aed', bg: 'linear-gradient(135deg,#1e3a5f,#0f1e2c)' },
              ...
              { pct: '10%', label: 'Sovereign Wealth Fund', desc: 'Long-term reserve, community reinvestment, and SOVEREIGNITITY™ protocol sustainability.', color: '#f59e0b', bg: 'linear-gradient(135deg,#4c1d95,#2d1b6e)' },
            ].map((c) => (
        ...
        <section style={s.section}>
          ...
          <div style={s.proofBox}>
            ...
            <div style={s.proofBody}>
              ...
              flow into the membership pool via the 70/20/10 model.
            </div>
          </div>
        </section>
