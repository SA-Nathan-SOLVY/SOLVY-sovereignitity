        ...
        <div style={s.container}>
          ...
          <div style={s.tableWrap}>
            <table style={s.table}>
              ...
              <tbody>
                {[
                  ['White trustees controlled Black deposits', 'Member-owned: 70% of revenue held in the membership pool'],
                  ...
                  ['Wealth extracted from community', '70/20/10 model: Wealth pooled for those who create it, distributed at maturity'],
                ].map(([left, right]) => (
        ...
        <div style={s.container}>
          ...
          <div style={s.pillarsGrid}>
            {[
              ...
              { icon: '💰', title: '70/20/10 on Data Revenue', body: 'The same cooperative split applies to data sales: 70% to the membership pool — held for contributing members, 20% to operations, 10% to the Sovereign Wealth Fund.' },
