      ...
      <section style={s.section}>
        <div style={s.container}>
          ...
          <div style={s.splitDiagram}>
            {[
              { pct: '70%', label: 'Membership Pool', meaning: 'Direct descendant protection — revenue held for those who generate it. Distribution is decided later, at maturity, guided by DECIDEY financial education. Pooled funds seed larger member projects, including MOLI (Member-Owned Life Insurance) — conceived in the spirit of BOLI (Bank-Owned Life Insurance), with established relationships for IBC policy underwriting.' },
              { pct: '20%', label: 'Operations', meaning: 'Pays for the services the cooperative runs on — BaaS, the self-sovereign software stack, and key employees — keeping the platform running and growing.' },
            ...
            <table style={s.table}>
              ...
              <tbody>
                {[
                  ...
                  ['70/20/10 Split', 'Mathematical expression of "leave them better" — 70% Membership Pool (held for members; distribution decided at maturity, with DECIDEY financial education), 20% Operations, 10% Sovereign Wealth Fund (SOVEREIGNITITY™).'],
