      ...
      <section style={s.section}>
        <div style={s.container}>
          ...
          <p style={s.bodyText}>
            ...
            consent, and pooled into the membership pool — <em>value held for you until the cooperative, at maturity, decides its distribution</em>.
          </p>
          ...
          <div style={s.threeGrid}>
            {[
              ...
              },
              {
                ...
                body: '70% of interchange fees + data licensing revenue flows into the membership pool, held for members. Your identity builds value while you sleep — distribution is decided later, at maturity, with DECIDEY financial education.',
              },
            ].map((item) => (
        ...
        <div style={s.container}>
          ...
          <ul style={s.moliList}>
            {[
              ...
              'Passes generational wealth: the membership pool and sovereign wealth fund reinforce MOLI beneficiaries in need',
            ].map((item) => (
      ...
      <section style={{ ...s.section, background: 'rgba(147,51,234,0.05)' }}>
        <div style={s.container}>
          ...
          <div style={s.splitGrid}>
            {[
              { pct: '70%', label: 'Membership Pool', color: '#9333ea', desc: 'Held for members — the distribution decision comes later, at maturity, guided by DECIDEY financial education. Your spending is your equity.' },
              { pct: '20%', label: 'Operations', color: '#14b8a6', desc: 'Pays for the services the cooperative runs on — BaaS, the self-sovereign software stack, and key employees.' },
              { pct: '10%', label: 'Sovereign Wealth Fund', color: '#f59e0b', desc: 'The cooperative fist — long-term sovereign capital and SOVEREIGNITITY™ protocol sustainability that keeps the infrastructure free.' },
            ].map((item) => (
        ...
        <div style={s.container}>
          ...
          <div style={s.principlesGrid}>
            {[
              ...
              { num: '02', title: 'Revenue Ownership', body: '70% of interchange fees flow to the membership pool, held for members. When the cooperative succeeds, you succeed.' },
              ...
              { num: '04', title: 'Collective Protection', body: "The 20% operations slice pays for BaaS, the self-sovereign software stack, and key employees. The 10% sovereign wealth fund builds long-term cooperative capital." },
