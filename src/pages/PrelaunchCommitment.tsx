    ...
    <div style={styles.body}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.urgencyBanner}>
          <div style={styles.urgencyLeft}>
            ...
            <span style={styles.urgencyText}>
              Cooperative card program · Card-issuing infrastructure — in development · Crypto/fiat bridge — on the roadmap
            </span>
          </div>
        </div>
        ...
        <div style={styles.partnerStrip}>
          {[
            { name: 'Card Issuing', icon: '💳', status: 'Infrastructure' },
        ...
        <div style={styles.twoColumns}>
          <div style={styles.panel}>
            ...
            <ul style={styles.featureList}>
              ...
              <li style={styles.featureItem}>
                <span style={styles.check}>✓</span>
                <span>🏦 <strong>FDIC-insured</strong> card issuance & banking</span>
              </li>
              <li style={styles.featureItem}>
                <span style={{ color: '#94a3b8', fontWeight: 'bold', flexShrink: 0 }}>◷</span>
                <span>💳 <strong>Card-issuing infrastructure</strong> <em style={{ color: '#94a3b8', fontSize: '0.85em' }}>(in development)</em></span>
              </li>
              <li style={styles.featureItem}>
                <span style={{ color: '#94a3b8', fontWeight: 'bold', flexShrink: 0 }}>◷</span>
                <span>🔁 <strong>Crypto/fiat bridge</strong> <em style={{ color: '#94a3b8', fontSize: '0.85em' }}>(on the roadmap)</em></span>
              </li>
              <li style={styles.featureItem}>
                <span style={styles.check}>✓</span>
